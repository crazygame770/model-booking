      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="grid grid-cols-3 gap-4">
          <div>
            <input
              type="number"
              placeholder="Age"
              className={`p-2 border rounded w-full ${errors.age ? 'border-red-500' : 'border-gray-300'}`}
              value={formData.age}
          ...
          <div>
            <input
              ...
              className={`p-2 border rounded w-full ${errors.height ? 'border-red-500' : 'border-gray-300'}`}
          ...
          <div>
            <input
              ...
              className={`p-2 border rounded w-full ${errors.weight ? 'border-red-500' : 'border-gray-300'}`}
        ...
        <div>
          <textarea
            ...
            className={`w-full p-2 border rounded h-24 ${errors.experience ? 'border-red-500' : 'border-gray-300'}`}
